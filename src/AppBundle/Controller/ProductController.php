...
use AppBundle\Form\ShishaArtikelType;
...
class ProductController extends Controller {
  ...
  public function showProducten() {
    ...
    $producten0 = $em->getRepository('AppBundle\Entity\Product')->findBy(array('populariteit' => 0, 'shishapen' => false)); //specials
    $producten1 = $em->getRepository('AppBundle\Entity\Product')->findBy(array('populariteit' => 1, 'shishapen' => false)); //actieve verkoop
    $producten2 = $em->getRepository('AppBundle\Entity\Product')->findBy(array('populariteit' => 2, 'shishapen' => false)); //shisha pennen
  ...
  public function showShishaArtikelen() {
    ...
    $producten = $em->getRepository('AppBundle\Entity\Product')->findBy(array('shishapen' => true));
